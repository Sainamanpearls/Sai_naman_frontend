...
const jewelryItems: JewelryItem[] = [
  { id: 1, thumbnail: "/hero/1.jpeg", background: "/hero/1.jpeg", title: "Wedding Rings" },
  { id: 2, thumbnail: "/hero/2.jpeg", background: "/hero/2.jpeg", title: "Pendant Necklace" },
  { id: 3, thumbnail: "/hero/3.jpeg", background: "/hero/3.jpeg", title: "Gold Rings" },
  { id: 4, thumbnail: "/hero/4.jpeg", background: "/hero/4.jpeg", title: "Diamond Ring" },
  { id: 5, thumbnail: "/hero/5.jpeg", background: "/hero/5.jpeg", title: "Luxury Jewelry" },
  { id: 6, thumbnail: "/hero/6.jpeg", background: "/hero/6.jpeg", title: "Elegant Necklace" },
  { id: 7, thumbnail: "/hero/7.jpeg", background: "/hero/7.jpeg", title: "Pearl Jewelry" },
];
...
export default function HeroSection() {
  ...
  return (
    <>
      <Helmet>
        <title>Sai Naman Pearls | Timeless Elegance</title>
        <meta
          name="description"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center text-center lg:text-left w-full">
            <div className="space-y-4 lg:space-y-6">
              ...
              <p className="text-2xl tracking-wide uppercase text-gray-300">
                STEP INTO A WORLD WHERE ELEGANCE <br></br>
                 DEFINES YOUR LIFESTYLE.
              </p>

              <p className="text-gray-300 max-w-md mx-auto lg:mx-0 text-base">Elevate your lifestyle with our luxurious pearls, where every pearl is accompanied by a distinguished guarantee certificate of authenticity
              </p>

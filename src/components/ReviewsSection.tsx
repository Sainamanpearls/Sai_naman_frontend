  ...
  return (
    <section className="py-16 bg-black relative">
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Read genuine customer reviews for Sai Naman Pearls. See why jewelry lovers worldwide trust our pearl collections and rate us highly."
        />
        <meta name="keywords" content="Sai Naman Pearls reviews, jewelry reviews, pearl jewelry feedback" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {loading ? (
          <p className="text-zinc-400 py-12">Loading reviews...</p>
        ) : reviews.length === 0 ? (
          <p className="text-zinc-400 text-lg py-12">No reviews yet</p>
        ) : (

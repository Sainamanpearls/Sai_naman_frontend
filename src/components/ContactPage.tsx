...
import { Helmet } from 'react-helmet-async';
  ...
  const pageTitle = 'Contact Us | Sai Naman Pearls Hyderabad';
  const pageDescription =
    'Get in touch with Sai Naman Pearls for any inquiries, assistance, or store visits. Contact us via phone, email, or by visiting our Hyderabad showroom.';
  const canonicalUrl = 'https://www.sainamanpearls.com/contac'
...
export default function ContactPage({ onBack }: ContactPageProps) {
  ...
  return ( 
      ...
      <Helmet>
        ...
        <meta property="og:image" content="https://www.sainamanpearls.com/assets/contact-preview.jpg" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={pageTitle} />
        <meta name="twitter:description" content={pageDescription} />
        <meta name="twitter:image" content="https://www.sainamanpearls.com/assets/contact-preview.jpg" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            image: "https://www.sainamanpearls.com/logo.png",
            url: canonicalUrl,
            telephone: "+91 9849472755",
    ...
    <div className="relative bg-gradient-to-b from-black via-slate-900 to-black py-20 text-white overflow-hidden px-4 py-12 pt-32">
